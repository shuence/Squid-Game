...
function loseDisplay(){
    $('#container').hide();
    var lost = `<div id="box">
    <h1 style="line-height: 100px; background-color: #333;">So sad how you couldn't win a kids game even though your life depended on it 🙄</h1>
...
function winDisplay() {
    ...
    $('#container').hide();
    var win = `<div id="box">
            <h1 style="line-height: 100px; background-color: #333;">Congratulations, you survived! 🥺😌</h1>
            <p style="background-color: #333;">Refresh the page to play again.</p>
    </div>`;
